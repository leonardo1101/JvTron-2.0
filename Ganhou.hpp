...
Ganhou::Ganhou(float larg, float alt): maxNumeroItens(2){
	...
	titulo.setString("Sobreviveu");
	titulo.setFont(fonte);
	titulo.setPosition(sf::Vector2f(centrox - titulo.getCharacterSize()*3.22, centroy-altura*1/2 + titulo.getCharacterSize() - 10));
	titulo.setColor(cor);
...
int Ganhou::Executar(sf::RenderWindow &App){
...
void Ganhou::desenha(sf::RenderWindow & App) const{
    ...
    sf::Texture textura;
    sf::Sprite sprite;
    imagem.loadFromFile("ganhou.png");
