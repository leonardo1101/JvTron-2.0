...
Regras1::Regras1(float larg, float alt):  maxNumeroTeclas(4), maxNumeroBotoes(2){
	std::string textoBotao[maxNumeroBotoes] = { "Voltar", "Proximo"}; // textoBotao do botão
